...
public class ModelAssertions extends AbstractAssert<ModelAssertions, Object> {
    ...
    public ModelAssertions match() throws NoSuchFieldException, IllegalAccessException {
        models.comparison.ModelComparisonConfigLoader configLoader = new models.comparison.ModelComparisonConfigLoader("model-comparison.properties");
        models.comparison.ModelComparisonConfigLoader.ComparisonRule rule = configLoader.getRuleFor(request.getClass());
