...
public class ModelComparator {
    ...
    public static <A, B> ComparisonResult compareFields(A request, B response, Map<String, String> fieldMappings) throws NoSuchFieldException, IllegalAccessException {
        ...
        for (Map.Entry<String, String> entry : fieldMappings.entrySet()) {
            ...
            Object value1 = getByPath(request, requestField);
            Object value2 = getByPath(response, responseField);
    ...
    static Object getByPath(Object obj, String path) throws IllegalAccessException, NoSuchFieldException {
        for (String part : path.split("\\.")) {
            if (obj == null) return null;
            Field f = obj.getClass().getDeclaredField(part);
